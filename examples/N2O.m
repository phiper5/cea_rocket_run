...
inp('ox') = 'N2O';              % Ox name from thermo.inp
inp('ox_t') = 298;                  % Ox inlet temperature
inp('file_name') = 'N2O_T.inp';    % Input/output file name
if CEA_RUN
